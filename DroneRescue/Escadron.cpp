...
{
	// À compléter
	//o << getName() << " (div : " << getDivision() << ")";
	//AdminUnit::printToStream(o);
...
void Escadron::accept(class AbsUnitVisitor& v)
{
	v.visitEscadron(*this);
}
void Escadron::accept(class AbsUnitVisitor& v) const
{
	v.visitEscadron(const_cast<const Escadron&>(*this));
}